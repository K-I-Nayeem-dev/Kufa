...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('dashboard_assests') }}/images/favicon.png">
	<link rel="stylesheet" href="./vendor/chartist/css/chartist.min.css">
    <link href="{{ asset('dashboard_assests') }}/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="{{ asset('dashboard_assests') }}/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="{{ asset('dashboard_assests') }}/css/style.css" rel="stylesheet">
...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ route('home') }}" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('dashboard_assests') }}/images/logo.png" alt="">
                <img class="logo-compact" src="{{ asset('dashboard_assests') }}/images/logo-text.png" alt="">
                <img class="brand-title" src="{{ asset('dashboard_assests') }}/images/logo-text.png" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                        ...
                                        @else
                                            <img src="{{ asset('dashboard_assests') }}/images/profile/17.jpg" width="20" alt=""/>
                                        @endif
				...
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="{{ route('recent.create') }}">Recent Best Works</a></li>
							<li><a href="{{ route('facts.create') }}">Facts Area</a></li>
							<li><a href="{{ route('testimonial.create') }}">Testimonial</a></li>
							<li><a href="{{ route('brand.create') }}">Brands-Logo</a></li>
						</ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        <i class="flaticon-381-networking"></i>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ route('recent.index') }}">Recent Best Works</a></li>
                            <li><a href="{{ route('fact.index') }}">Facts Area</a></li>
                            <li><a href="{{ route('testimonial.index') }}">Testimonial</a></li>
                            <li><a href="{{ route('brand.index') }}">Brands-Logo</a></li>
                            <li><a href="{{ route('contact') }}">Contact Email</a></li>
                        </ul>
                    </li>
                    <li><a href="{{ route('profile') }}" aria-expanded="false">
    ...
    ***********************************-->
    <!-- Required vendors -->
	@stack('js')
    <script src="{{ asset('dashboard_assests') }}/vendor/global/global.min.js"></script>
	<script src="{{ asset('dashboard_assests') }}/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
	<script src="{{ asset('dashboard_assests') }}/vendor/chart.js/Chart.bundle.min.js"></script>
    <script src="{{ asset('dashboard_assests') }}/js/custom.min.js"></script>
	<script src="{{ asset('dashboard_assests') }}/js/deznav-init.js"></script>
	<script src="{{ asset('dashboard_assests') }}/vendor/owl-carousel/owl.carousel.js"></script>
	
	<!-- Chart piety plugin files -->
    <script src="{{ asset('dashboard_assests') }}/vendor/peity/jquery.peity.min.js"></script>
	
	<!-- Apex Chart -->
	<script src="{{ asset('dashboard_assests') }}/vendor/apexchart/apexchart.js"></script>
	
	<!-- Dashboard 1 -->
	<script src="{{ asset('dashboard_assests') }}/js/dashboard/dashboard-1.js"></script>
	<script>
